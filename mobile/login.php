...
<body>
<div id="login">
  <form id="login_form" action="check_login.php" method="post">
    <div class="field_container">
      <input type="text" placeholder="Email Address" id="txtUsername" name="txtUsername">
    </div>

    <div class="field_container">
      <input type="Password" placeholder="Password" id="txtPassword" name="txtPassword">
      <button id="sign_in_button">
        <span class="button_text">เข้าสู่ระบบ</span>
      </button>
    </div>
</div>
</body>
